...
interface IA {
	public int f();
	public abstract int p(int m);
	public abstract int q(int m);
}
...
class A2  implements IA {
	...
	public int f() {
		...
		return a1 + this.p(100) + this.q(100);
	}
...
class C2 implements IC {
	...
	public int r() {
		if(this2 != null) {
			return this2.f() + this2.g() + h() + c1;
		}
		return this.f() + this.g() + h() + c1;
	}
...
class D2 implements ID {
	...
	public int r() {
		...
		return this.f() + this.g() + this.h() + super2.c1;
	}
